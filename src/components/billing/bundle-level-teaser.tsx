...
export function BundleLevelCard({ teaser }: BundleLevelCardProps) {
  return (
    <div className="rounded-3xl border border-dashed border-violet-300 bg-gradient-to-br from-violet-50 via-fuchsia-50 to-amber-50 p-4 shadow-sm">
      <p className="text-xs font-medium text-violet-600">成长包</p>
      <p className="mt-1 text-sm font-bold leading-snug text-violet-900">
        {teaser.emoji} {teaser.title}
      </p>
      <p className="mt-2 text-sm text-amber-600">敬请期待</p>
      <p className="mt-3 text-center text-xs text-violet-500/80">{teaser.hint}</p>

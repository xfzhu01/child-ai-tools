  ...
  return (
    <div className="relative mx-auto max-w-3xl px-5 py-16">
      <div
        ...
        aria-hidden
      >
        <div className="absolute -top-24 left-1/2 h-72 w-[500px] -translate-x-1/2 rounded-full bg-indigo-100/50 blur-3xl" />
      </div>

      <div className="text-center">
        <h1 className="text-3xl font-black text-slate-900 md:text-4xl">帮助中心</h1>
        <p className="mt-2 text-slate-500">常见问题解答</p>
      </div>

      <div className="mt-10 space-y-4">
        {faqs.map((faq) => (
          <Card key={faq.q} className="transition hover:shadow-md">
            <h2 className="text-base font-bold text-slate-900">{faq.q}</h2>
